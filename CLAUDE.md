...
- C# / .NET 10.0 + WolverineFx 5.22.x (command/query bus), Microsoft.AspNetCore.Authentication.JwtBearer 10.0.x, Serilog 4.3.x, xUnit 2.9.x, Microsoft.AspNetCore.Mvc.Testing 10.0.x (003-user-mgmt-api)
- In-memory `ConcurrentDictionary` (consistent with existing feature 001 pattern; persistent store deferred) (003-user-mgmt-api)
